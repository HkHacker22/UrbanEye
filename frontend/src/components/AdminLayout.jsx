  ...
  return (
    <div className="hidden lg:flex flex-col w-64 border-r border-gray-200 min-h-screen p-5 sticky top-0 bg-white z-20">
      ...
      <div className="pt-4 border-t border-gray-100 mt-auto flex flex-col gap-1 w-full text-gray-600">
        <Link to="/admin/support" className="flex items-center gap-3 p-3 rounded-xl transition-all duration-200 font-medium hover:bg-gray-100 w-full text-[15px]">
    ...
    <div className="sticky top-0 z-30 bg-white border-b border-gray-200 px-4 md:px-6 py-3 flex flex-wrap items-center justify-between shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
      ...
      {showMobileMenu && (
        <div className="lg:hidden w-full basis-full mt-4 flex flex-col gap-1 border-t border-gray-100 pt-3 animate-in slide-in-from-top-1">
          <Link to="/admin/support" onClick={() => setShowMobileMenu(false)} className="flex items-center gap-3 p-3 rounded-xl transition-all duration-200 font-medium hover:bg-gray-100 w-full text-[15px] text-gray-600">
            <LifeBuoy size={22} /> Support
          </Link>
